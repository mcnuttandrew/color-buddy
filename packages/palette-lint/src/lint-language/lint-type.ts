...
/**
 * Converts a Color to a color space component. Has syntax like colorSpace.channel, where colorSpace is a color space and channel is a channel in that color space. Available spaces: hsl, hsv, jzazbz, lab, lch, hct, cam16-jmh, oklch, rgb, oklab
 */
